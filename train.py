...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='/opt/data/private/ZT/fuxian/CCTrans-main/data/nwpu-Train-Val-Test', help='data path')
    parser.add_argument('--dataset', default='nwpu', help='dataset name: qnrf, nwpu, sha, shb, custom')
    ...
    parser.add_argument('--run-name', default='FGFDETR', help='run name for wandb interface/logging')
